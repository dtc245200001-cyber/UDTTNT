    ...
    const ticketHtml = `
      <div style="border: 2px dashed #5C2C16; padding: 20px; border-radius: 12px; max-width: 500px; margin: 0 auto; background: #FFFDF9;">
        <div style="text-align: center; border-bottom: 1px solid #ddd; padding-bottom: 10px; margin-bottom: 15px;">
          <h2 style="color: #5C2C16; margin: 0;">BẢO TÀNG LỊCH SỬ QUỐC GIA</h2>
        ...
        <div style="text-align: center; margin-top: 20px; padding-top: 15px; border-top: 1px solid #ddd;">
          ...
          <p style="font-size: 11px; color: #666; margin-top: 5px;">Quét mã QR tại cổng soạt vé tự động để vào cổng</p>
        </div>
      </div>
    `;
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 font-sans animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-4">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-museum-gold hover:bg-museum-gold-lt text-white font-bold text-xs rounded-xl shadow-md transition-colors w-fit"
        >
          + Đặt thêm vé mới
        </button>
      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
                  <div className="sm:col-span-7 space-y-2 text-xs">
                    ...
                    <div className="pt-1 border-t border-gray-100 text-[11px] text-gray-500 space-y-0.5">
                      ...
                      <div>Thanh toán: <span className="font-semibold text-museum-brown">{t.paymentMethod || 'VNPay'}</span></div>
                    </div>
                  </div>
