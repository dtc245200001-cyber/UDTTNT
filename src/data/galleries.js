export const initialGalleries = [
  {
    ...
    description: 'Ứng dụng công nghệ tương tác số hiện đại (3D mapping, hologram, AI, gauze projection) kết hợp trưng bày 14 hiện vật gốc tiêu biểu để diễn giải sinh động 4 trụ cột đỉnh cao: Kiến trúc chùa tháp, Điêu khắc đá, Đồ gốm men và Âm nhạc vũ đạo Phật giáo thời Lý.',
    status: 'Đang diễn ra',
    startDate: '2025-05-16',
    endDate: '2026-11-30',
    location: 'Phòng Trưng bày Chuyên đề số 1, Tầng 1 – Số 1 Tràng Tiền, Hoàn Kiếm, Hà Nội',
    sourceUrl: 'https://nhandan.vn/vu-khuc-thien-mon-gioi-thieu-nghe-thuat-phat-giao-thoi-ly-post880239.html',
    detailedContent: `Trưng bày chuyên đề "Vũ khúc Thiền môn - Nghệ thuật Phật giáo thời Lý: Di sản và Công nghệ" do Bảo tàng Lịch sử Quốc gia phối hợp cùng Viện Nghiên cứu Văn minh Châu Á và Công ty TNHH C.M.Y.K Việt Nam tổ chức nhân dịp Ngày Quốc tế Bảo tàng, Ngày Khoa học Công nghệ Việt Nam (18/5) và kỷ niệm 135 năm Ngày sinh Chủ tịch Hồ Chí Minh.
...
Đặc biệt, sự kết hợp của các kỹ thuật công nghệ số đỉnh cao gồm 3D Mapping, Hologram 3 chiều, Phục dựng kỹ thuật số (Digital Revival), Gauze Projection (trình diễn sương mù) và Trí tuệ nhân tạo (AI) giúp tái sinh các "mảnh vỡ di sản", mang lại cho công chúng trải nghiệm đa giác quan sâu sắc và sống động.`,
    ...
    galleryImages: [
      ...
      'https://yzscfptnwecjutaobyzm.supabase.co/storage/v1/object/public/anh_hien_vat/anh19.avif',
      'https://yzscfptnwecjutaobyzm.supabase.co/storage/v1/object/public/anh_hien_vat/anh20.avif',
      'https://yzscfptnwecjutaobyzm.supabase.co/storage/v1/object/public/anh_hien_vat/anh21.avif',
      'https://yzscfptnwecjutaobyzm.supabase.co/storage/v1/object/public/anh_hien_vat/anh22.avif',
      'https://yzscfptnwecjutaobyzm.supabase.co/storage/v1/object/public/anh_hien_vat/anh23.avif',
      'https://yzscfptnwecjutaobyzm.supabase.co/storage/v1/object/public/anh_hien_vat/anh24.avif',
    ],
    highlightArtifacts: [
      {
