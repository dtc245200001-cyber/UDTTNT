...
('TBCD01', 'Vũ khúc Thiền môn - Nghệ thuật Phật giáo thời Lý: Di sản và Công nghệ',
 ...
 'Trưng bày "Vũ khúc Thiền môn" là điểm nhấn đột phá trong việc ứng dụng công nghệ số vào diễn giải di sản văn hóa. Thông qua công nghệ trình chiếu 3D mapping, hologram và AI, công chúng được chiêm ngưỡng trọn vẹn vẻ đẹp uy nghiêm của nghệ thuật Phật giáo thời Lý.',
 '/images/tuong-phat.jpg',
 '["/images/tuong-phat.jpg", "/images/trong-dong.jpg", "/images/museum-hero.jpg"]'::jsonb,
 '[
   {"name": "Tượng Phật A Di Đà chùa Phật Tích", "description": "Tuyệt tác điêu khắc đá xanh thời Lý (thế kỷ 11) được tái hiện sống động bằng công nghệ số và ánh sáng hologram.", "image": "/images/tuong-phat.jpg", "period": "Thời Lý (Thế kỷ 11)"},
   {"name": "Đầu rồng đất nung thời Lý hoàng thành Thăng Long", "description": "Hiện vật đất nung tinh xảo trang trí bờ nóc cung điện thời Lý, thể hiện đường nét uyển chuyển đặc trưng.", "image": "/images/museum-building.jpg", "period": "Thời Lý (Thế kỷ 11 - 12)"},
   {"name": "Gạch hoa cúc và lá đề chạm rồng thời Lý", "description": "Vật liệu kiến trúc cung đình mang biểu tượng Phật giáo và sự thịnh vượng của vương triều.", "image": "/images/bia-tien-si.jpg", "period": "Thời Lý (Thế kỷ 11 - 13)"}
 ]'::jsonb),
